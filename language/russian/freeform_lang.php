 ...
 * @version		4.0.7
 * @filesource 	./system/expressionengine/third_party/freeform/language/russian/
 * переведено в студии FDCore (fdcore.com)
 */
...
"Создание продвинутой формы сбора данных",
...
"Вы знали, что Freeform Pro позволяет использовать больше типов полей? Получите Про версию за $79.95.",
...
"Обновить модуль Freeform",

'freeform_update_message' =>
"Недавно Вы закачали новую версию модуля Freeform, пожалуйста, запустите обновление скрипта.",

"update_successful" =>
"Модуль Freeform успешно обновлён.",

"update_failure" =>
"Во время обновления произошла ошибка. Попробуйте обновить модуль до последний версии.",

// -------------------------------------
//	Список стран, регионов, городов.
// -------------------------------------
